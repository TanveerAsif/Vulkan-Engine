...
//  'io.ConfigFlags |= ImGuiConfigFlags_NoMouseCursorChange'. [X] Multiple Dear ImGui contexts support.
...
//  2025-12-10: Avoid repeated glfwSetCursor()/glfwSetInputMode() calls when unnecessary. Lowers overhead for very high
//  framerates (e.g. 10k+ FPS). 2025-11-06: Lower minimum requirement to GLFW 3.0. Though a recent version e.g GLFW 3.4
//  is highly recommended. 2025-09-18: Call platform_io.ClearPlatformHandlers() on shutdown. 2025-09-15: Content Scales
//  are always reported as 1.0 on Wayland. FramebufferScale are always reported as 1.0 on X11. (#8920, #8921)
...
// GLFW
#if !defined(IMGUI_IMPL_GLFW_DISABLE_X11) && (defined(__linux__) || defined(__FreeBSD__) || defined(__OpenBSD__) ||    \
