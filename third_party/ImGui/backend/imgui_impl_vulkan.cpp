...
//  2025-11-24: Vulkan: Helper for creating a swap-chain (used by examples and multi-viewports) selects
//  VkSwapchainCreateInfoKHR's compositeAlpha based on cap.supportedCompositeAlpha. (#8784) 2025-10-15: Vulkan: Added
//  IMGUI_IMPL_VULKAN_VOLK_FILENAME to configure path to volk.h header. (#9008) 2025-09-26: *BREAKING CHANGE*: moved
//  some fields in ImGui_ImplVulkan_InitInfo: init_info.RenderPass --> init_info.PipelineInfoMain.RenderPass,
//  init_info.Subpass --> init_info.PipelineInfoMain.Subpass, init_info.MSAASamples -->
