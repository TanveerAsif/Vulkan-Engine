...
static ExampleTreeNode* ExampleTree_CreateDemoTree()
{
    ...
    {
        snprintf(name_buf, IM_COUNTOF(name_buf), "%s %d", root_names[idx_L0 / root_items_multiplier],
...
static void DemoWindowWidgetsDragsAndSliders()
{
    ...
    if (ImGui::TreeNode("Drag/Slider Flags"))
    {
        ...
        // ImGuiSliderFlags_ColorMarkersIndexShift_); // Not explicitly documented but possible.
