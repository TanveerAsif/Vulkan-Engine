...
PhysicalDevice::PhysicalDevice() : mSelectedPhysicalDeviceIndex(-1) // No physical device selected
{
}
...
void PhysicalDevice::init(const VkInstance& instance, const VkSurfaceKHR& surface)
{
    ...
    for (uint32_t i = 0; i < deviceCount; ++i)
    {
        ...
        // Get memory properties : 1- memory heaps, 2- memory types : memory that is local to the device, memory that is
        // visible to the host CPU etc.,
