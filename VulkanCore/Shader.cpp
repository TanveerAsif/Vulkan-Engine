...
VkShaderModule CreateShaderModuleFromText(const VkDevice &device,
  ...
  shaderc::SpvCompilationResult module = compiler.CompileGlslToSpv(
      sourceCode, shaderKind, shaderCode.c_str(), options);
  ...
  if (spirvFile.is_open()) {
    spirvFile.write(reinterpret_cast<const char *>(spirvCode.data()),
